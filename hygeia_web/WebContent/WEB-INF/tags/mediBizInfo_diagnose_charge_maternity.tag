...
<%
    String bka006Filter = " data_value like '51%'";
...
function chooseDis(str) {
	popupDialog(
			{
				url : "${rootPath}/common/CommonManagerAction!chooseDisease.action?ka06dto.aka035=5",
				onClosed : function() {
...
<powersi:editorlayout cols="15%,9%,13%,9%,15%,9%,15%,10%,15%">
	...
	<tr>
		...
		<powersi:textfield id="bka888" key="基金冻结情况" name="diagnoseInfoDTO.bka888"
			readonly="true"/>
		<powersi:textfield id="aac001" name="diagnoseInfoDTO.aac001" label="电脑号" 
			readonly="true" value="" />	
	</tr>
	<tr>
	...
	<tr>
		<powersi:textfield id="bkz101" key="疾病诊断" readonly="true"
			...
			required="true"/>
	    <powersi:codeselect id="akf001" name="diagnoseInfoDTO.akf001" showValue="true"
			label="科室" cssClass="select2" list="#request.bka019List"
			headerKey="" headerValue="请选择..." onchange="selectbka021()" />
		<powersi:codeselect id="bka021" name="diagnoseInfoDTO.bka021" showValue="false"
	...
	<tr >
		<powersi:textfield id="amc023" name="diagnoseInfoDTO.amc023" label="结婚证号" />	
		<powersi:textfield id="amc021" name="diagnoseInfoDTO.amc021" label="准生证号" />	
	</tr>
