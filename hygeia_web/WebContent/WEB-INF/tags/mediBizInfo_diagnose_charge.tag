...
<%
	...
	String aaa027_str=aaa027.substring(0,4);
%>
<script type="text/javascript">
	window.onload=function(){
		if(<%=aaa027_str%> != null && <%=aaa027_str%> != "4404"){
			$("#bka898_str").remove();
		}
	};
	...
	<s:editorlayout cols="8">
		...
		<tr>
			<s:textfield id="bka025" key="挂号" name="diagnoseInfoDTO.bka025"
				readonly="true" />
			<s:textfield id="bka043" key="处方号" name="diagnoseInfoDTO.bka043"
				readonly="true" />
		...
		<tr>
			...
			<s:textfield id="bka020" key="科室" name="diagnoseInfoDTO.bka020"
				readonly="true" />
			<s:textfield id="bka022" key="病区" name="diagnoseInfoDTO.bka022"
				readonly="true" />
			<s:codeselect codeType="bka503" id="bka503" label="医保医师"
				name="diagnoseInfoDTO.bka503" key="bka503" codeFilter=""
				codeSort="1" onchange="" disabled="true" />
		</tr>
		<tr id="bka898_str">
			<s:codeselect id="bka898" key="缴费档次"
				name="diagnoseInfoDTO.bka898" codeType="bka898" disabled="true" />
		</tr>
	</s:editorlayout>
</s:panelbox>