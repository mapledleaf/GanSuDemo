...
<body>
	...
	<powersi:groupbox title="数据列表">
		<powersi:datagrid id="grid" formId="queryForm" delayLoad="true" height="410" rowAttrRender="gridRowRender" 
			...
			<powersi:datagrid-column display="政策编码" name="policy_code" data="policy_code" width="10%"  hide="false"/>
			<powersi:datagrid-column display="政策码值" name="policy_value" data="policy_value" width="10%"  hide="false"/>
