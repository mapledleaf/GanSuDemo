...
<powersi:html>
<head>
<powersi:head title="权限信息变更查询" />
</head>
<body>
	<powersi:panelbox key="panel_query" allowAddition="true">
		<powersi:form id="queryForm" namespace="/user" action="UserRightAction!queryUserChangeInfo">
			<powersi:editorlayout cols="6">
				...
				<powersi:editorlayout-row addition="true">
					<powersi:radio list="#{0:'全部',1:'增加',2:'删除'}" id="searchChangeDtoeventType" name="searchChangeDto.eventType" label="变更类型" />
				...
				<powersi:editorlayout-row addition="true">
					<powersi:textfield id="searchChangeDtouserName" name="searchChangeDto.userName" label="角色名称" />
	...
	<powersi:panelbox key="panel_result" title="变更列表">
		<powersi:datagrid id="grid" formId="queryForm" 
			...
			<powersi:datagrid-column display="角色名称" name="user_name" width="100" />
...
<script type="text/javascript">
	...
	function getExportFileName() {
		var filename = '权限变更(' + $('#beginDate').val().substring(0, 10)
