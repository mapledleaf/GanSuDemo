...
function showDoubt(aaz328,aaz010){
	var url = "${rootPath}/medicare/DeclarePayAction!getDoubtDetailDoctor.action";
	var params = {};
	params.aaz328 = aaz328;
	params.aaz010 = aaz010;
...
function deleteFile(aaz530, ape023, ape022){
	...
	postJSON("${rootPath}/medicare/DeclarePayAction!deleteAppealData.action?"+
...
function saveAppealExplain(){
	...
	postJSON("${rootPath}/medicare/DeclarePayAction!saveAppealExplain.action", params, checkreturn);
}
...
function appealExplain(aaz328){
	...
	var params = {};
	params.aaz328 = aaz328;
	postJSON("${rootPath}/medicare/DeclarePayAction!getAppealExplain.action", params, appealInfoCall);
}
...
$(document).ready(function() {
	var aaz328 = $('#aaz328').val();
	var aaz010 = $('#aaz010').val();
	showDoubt(aaz328,aaz010);
	/* initData4Complaint();
	initFileUpload();
