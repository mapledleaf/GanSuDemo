...
function editinfo(aaz328, aaz010){
	popupDialog('${rootPath}/hosp/appealAction!getDoctorAppealHandle.action?'+
...
<body style="overflow: hidden">
	<powersi:form name="mainForm" id="mainForm" action="/hosp/appealAction!getDoctorAppealInfo.action" namespace="/hospform">
		...
		<powersi:panelbox-toolbar>
			...
			<powersi:editorlayout cols="8" id="conditiontable" >
				...
				<powersi:editorlayout-row >
					...
					<s:if test="#session.SessionUserKey.user_class!='3'.toString()">
						<processTag:doctorChoose/>
					</s:if>
					<s:else>
