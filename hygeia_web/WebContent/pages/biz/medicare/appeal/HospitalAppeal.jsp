		...
		<powersi:panelbox iconClass="icon-inbox" title="查询条件">
			...
			<powersi:editorlayout cols="8" id="conditiontable" >
				<powersi:editorlayout-row>
					<powersi:hidden id="apa709" name="appealDTO.apa709" value="3"></powersi:hidden>
				</powersi:editorlayout-row>
				<powersi:editorlayout-row>
...
function editinfo(aaz328, aaz010){
	popupDialog('${rootPath}/medicare/DeclarePayAction!getHospitalAppealHandle.action?'+
			'aaz328='+aaz328+"&aaz010="+aaz010+"&apa709=3", 
