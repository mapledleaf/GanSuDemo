...
<powersi:html>
<head>
<powersi:head title="门诊慢性病收费" />
<%@ include file="/pages/util/header/combogrid.jsp"%>
</head>
<body>
	<div style="display: none;">
		<object id="scanCtrl"
			codeBase="${rootPath}/resource/cab/CommonScan.cab#version=1,0,0,15"
			width="0" height="0" border="0"
			classid="clsid:052EF1D8-34EC-4DF6-8652-8493CBC4A01C"> </object>
	</div>
					...
					function(json) {
						...
						if (json.errortype == '0') {
							...
							if (json.data.clinicapplyinfo != null){
								$("#aaz267").val(json.data.spinfo.aaz267);
							}
						} 
