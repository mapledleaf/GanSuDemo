		...
		<powersi:form id="f_query">
			...
			<powersi:editorlayout cols="8">
				...
				<powersi:editorlayout-row>
					...
					<powersi:codeselect id="bkp002" label="申报类型" name="q.bkp002" required="true" codeType="bkp002_zx_${AAA027}" headerKey=" " />
		...
		<powersi:tabbedpanel id="divTabs">
			...
			<div id="divTab2">
				<powersi:datagrid id="grid_detail" url="${ACTION}!queryDetail.action" delayLoad="true" enabledSort="false"
					...
					<powersi:datagrid-column name="daa027" display="拨付中心" render="function(r, i, v, c){return _render(r, i, v, {columnname:'daa027'});}"
						code="aaa027" />
