...
<script type="text/javascript">
	...
	function saveinfo() {
		...
		var param = $("#mainForm").serialize();
	 	...
	 	postJSON("${path}!verifyRepeat_120.action", param, function(json){
	 		if(null != json.data){
				if(json.data.returntype == "2"){
					popupConfirm(json.data.message,'您确定要删除有效的申请重新申请吗', function(yes){
						if(yes){
							param += "&dto.aaz267LisStr=" + json.data.aaz267LisStr;
							addinfo(param);
						}
					});
				}else{
