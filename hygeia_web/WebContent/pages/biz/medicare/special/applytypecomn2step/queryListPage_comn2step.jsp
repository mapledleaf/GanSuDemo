	...
	<powersi:form id="mainForm" action="specialManager!getSpeAppInfList.action" namespace="/medicarespecial">
		<powersi:panelbox title="查询条件">
			...
			<powersi:editorlayout cols="8">
				...
				<tr>
					<powersi:codeselect id="audit_status" name ="dto.audit_status" list="%{#{'':'全部','0':'未审核','3':'初审通过','4':'初审未通过','1':'复审通过','2':'复审未通过'}}" label="审核状态" />
					<powersi:codeselect id="aka083" name="dto.aka083" key="aka083" codeType="aka083" codeFilter="<%=aka083Filter %>" label="申请类型"/>
					<td colspan="4"/>
				</tr>
...
<script type="text/javascript">
	...
	function getDetailPage(aaz267, aka083) {
		var param = "dto.aae140=" + $("#aae140").val() + "&dto.pageFlag=" + getPageInitParamByApplyType(aka083, "pageFlag") + "&dto.aaz267=" + aaz267 + "&dto.aaa027=" + $("#aaa027").val() + "&dto.comFlag=21" + "&dto.caa027=" +$("#caa027").val();
