...
<body>
	...
	<powersi:form id="mainForm" action="specialManager!getQueryDetailPage.action" namespace="/medicarespecial">
		...
		<powersi:panelbox title="基本信息">
			...
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:codeselect id="bke035" name ="dto.bke035" list="%{#{'':'','11':'一站式转诊'}}" disabled="true" label="申请原因"/>
				</tr>
				<tr>
					<powersi:textfield id="aab299" name="dto.aab299" key="aab299" disabled="true" label="转诊城市" />
					<powersi:textfield id="ake014" name="dto.ake014" required="true" key="ake014" disabled="true" label="转院日期" />
					<powersi:codeselect id="bkm301" name="dto.bkm301" key="bkm301" codeType="bkm301" disabled="true" label="转诊类型" />
					<powersi:codeselect id="bke049" name="dto.bke049" key="bke049" codeType="bke049" disabled="true" label="转诊原因" />
				</tr>
				<tr>
					<powersi:textarea id="bke011" rows='1' name="dto.bke011" key="bke011" maxlength="165" colspan="3" disabled="true" label="转诊原因详情" />
					<powersi:textarea id="aae013" rows='1' name="dto.aae013" key="aae013" maxlength="165" colspan="3" disabled="true" label="备注（医嘱）" />
				</tr>
		...
		<powersi:groupbox title="转出信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="bke053" name="dto.bke053" readonly="true" label="转出医院"/>
					<powersi:hidden id="aaz286" name="dto.aaz286" readonly="true" label="转出医院编码" />
					
					<powersi:textfield id="bke051" name="dto.bke051" readonly="true" label="转出医院诊断" />
					<powersi:hidden id="bke046" name="dto.bke046" readonly="true" label="转出医院诊断编码" />
					<td colspan="4"/>
				</tr>
				<tr>
					<powersi:textarea id="bke007" rows='1' name="dto.bke007" key="bke007" maxlength="340" colspan="3" disabled="true" label="病情摘要" />
					<powersi:textarea id="bke008" rows='1' name="dto.bke008" key="bke008" maxlength="165" colspan="3" disabled="true" label="转出医院意见" />
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
		...
		<powersi:groupbox title="转入信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="akc172" name="dto.akc172" readonly="true" label="转入医院"/>
					<powersi:hidden id="ake017" name="dto.ake017" readonly="true" label="转入医院编码" />
					
					<powersi:textfield id="bke003" name="dto.bke003" readonly="true" label="转入医院诊断" />
					<powersi:hidden id="bke038" name="dto.bke038" readonly="true" label="转入医院诊断编码" />
					<td colspan="4"/>
				</tr>
				<tr>
					<powersi:textarea id="bke009" rows='1' name="dto.bke009" key="bke009" maxlength="340" colspan="3" disabled="true" label="病情摘要" />
					<powersi:textarea id="bke010" rows='1' name="dto.bke010" key="bke010" maxlength="165" colspan="3" disabled="true" label="转入医院意见" />
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
