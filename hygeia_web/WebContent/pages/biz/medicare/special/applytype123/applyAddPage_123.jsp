		...
		<!-- 用于初始化设置不可用的div --><div id="divshield"><powersi:groupbox title="基本信息">
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:codeselect id="bke035" name ="dto.bke035" list="%{#{'10':'请选择...','11':'一站式转诊'}}" label="申请原因"/>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bke001:1",
	                "aab299","ake014:1","bkm301","bke049","bke011:0,1","aae013:0,1",
	                "bke053:1","bke051:1","bke007:0,1","bke008:0,1",
	        		"akc172:1","bke003:1","bke009:0,1","bke010:0,1"]; 
	...
	function configSpecialKey(keyid){
		...
		if ("akb021" == keyid) {//选择申请医院
			...
			val++;
		}else if ("bkb023" == keyid) {//选择专家疾病
			chooseDis('',$("#bke025")[0], $("#bkb023")[0]);
			val++;
		}else if ("bke053" == keyid) {//转出医院
			chooseHosp($("#aaz286")[0], $("#bke053")[0]);
			val++;
		}else if ("bke051" == keyid) {//转出医院诊断
			chooseDis('',$("#bke046")[0], $("#bke051")[0]);
			val++;
		}else if ("akc172" == keyid) {//转入医院
			chooseHosp($("#ake017")[0], $("#akc172")[0]);
			val++;
		}else if ("bke003" == keyid) {//转入医院诊断
			chooseDis('',$("#bke038")[0], $("#bke003")[0]);
			val++;
		}
		return val;
	}
