	...
	<powersi:form id="mainForm" action="specialManager!getSpeAppInfList.action" namespace="/medicarespecial">
		<powersi:panelbox title="查询条件">
			...
			<div style="display: none">
				...
				<powersi:textfield id="aka083" name="dto.aka083" key="aka083" value="12S" label="申请类型"/>
...
<script type="text/javascript">
	...
	//新增申请页面
	function getAddPage() {
		var param = "dto.aae140=" + $("#aae140").val() + "&dto.pageFlag=" + getPageInitParamByApplyType($("#aka083").val(), 'pageFlag')
		...
		}, null, getPageInitParamByApplyType($("#aka083").val(), 'modifyPH'),pwidth);
	}
