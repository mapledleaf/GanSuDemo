		...
		<!-- 用于初始化设置不可用的div --><div id="divshield"><powersi:groupbox title="基本信息">
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:textfield id="aaz217" name="dto.aaz217" required="true" readonly="true" label="医疗就诊序号"/>
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
...
<script type="text/javascript">
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bke001",
	            	...
	            	"bke020","bke018","bke019","bke011","aae013","bke002:0,1","aae013:0,1"];
		...
		postJSON("${path}!getPersonInfo.action", param, function(json){
	    	...
	    	if (json.data != "no") {
			    ...
			    popupDialog(rootPath +"/medicarespecial/specialManager!openBiz.action?dto.aac001="
			    		+$("#aac001").val()+"&&dto.pageFlag="+$("#pageFlag").val()+"&&dto.akb020="+$("#akb020").val(),500, 800,
			    		function(ret){
					    	if (ret != null) {
					    		$("#aaz217").val(ret.aaz217);
					    		$("#akb021").val(ret.akb021);
					    		$("#akb020").val(ret.akb020);
								changeShield(0);
								//全键盘操作
								firstTabFocus();
					    	}else{
					    		popupAlert("请选择业务信息！", "提示", "warn");
					    	}
			    		});
		    	/* changeShield(0);
				//全键盘操作
