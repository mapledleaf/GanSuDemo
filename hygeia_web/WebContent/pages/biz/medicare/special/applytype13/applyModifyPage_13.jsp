	...
	<powersi:form id="mainForm" action="specialManager!modifySpeAppInf.action" namespace="/medicarespecial">
		...
		<powersi:groupbox title="基本信息">
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:codeselect id="aka083" name="dto.aka083" codeType="aka083" codeFilter="aaa102 in ('131','132','133')" required="true" label="申请类型"/>
		...
		<powersi:groupbox title="医院医保办意见">
			<powersi:editorlayout cols="8">
				...
				<tr>
					<powersi:textarea id="bke002" rows='3' name="dto.bke002" key="bke002" maxlength="165" colspan="8" label="诊断依据" />  
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
		...
		<powersi:groupbox title="鉴定专家意见">
			<powersi:editorlayout cols="8">
				...
				<tr>
					<powersi:textarea id="aae013" rows='3' name="dto.aae013" key="aae013" maxlength="165" colspan="8" label="备注" /> 
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
