...
<body>
	...
	<powersi:form id="mainForm" action="specialManager!getQueryDetailPage.action" namespace="/medicarespecial">
		...
		<powersi:panelbox title="基本信息">
			...
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:textfield id="aae127" name="dto.aae127" required="true" key="aae127" mask="date"  disabled="true" label="申请日期" />
					<powersi:textfield id="aae030" name="dto.aae030" required="true" key="aae030" mask="date" validate="funcCall[checkFunc]"  disabled="true" label="生效日期" />
					<powersi:textfield id="aae031" name="dto.aae031" required="true" key="aae031" mask="date" validate="funcCall[checkFunc]"  disabled="true" label="失效日期" />
		...
		<powersi:groupbox title="详细信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="bke053" name="dto.bke053" required="true" readonly="true" disabled="true" label="出院医院"/>
					<powersi:hidden id="aaz286" name="dto.aaz286" label="出院医院编码" />
					<powersi:textfield id="bke051" name="dto.bke051" required="true" readonly="true" disabled="true" label="出院诊断" />
					<powersi:hidden id="bke046" name="dto.bke046" label="出院诊断编码" />
					<powersi:textfield id="ake014" name="dto.ake014"  key="ake014" mask="date"  disabled="true"  label="出院日期" />
					<td colspan="2"/>
				</tr>
				<tr>
					<powersi:textarea id="bke011" rows='1' name="dto.bke011" key="bke011" maxlength="165" colspan="7" label="申请理由" disabled="true" />
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
		...
		<powersi:groupbox title="初审意见">
			<powersi:editorlayout cols="8">
				<tr>
					...
					<powersi:textfield id="bke022" name="dto.bke022" required="true"  disabled="true" key="bke022" mask="date" label="初审日期" />
					<powersi:textarea id="bke024" name="dto.bke024"  readonly="true" disabled="true" rows="1" colspan="3"  maxlength="165" validate="funcCall[checkFunc]" label="初审意见" />
				</tr>
		...
		<powersi:groupbox title="复审意见">
			<powersi:editorlayout cols="8">
				<tr>
					...
					<powersi:textfield id="aae015" name="dto.aae015" required="true" key="aae015" mask="date" disabled="true" label="复审日期" />
					<powersi:textarea id="aae189"  name="dto.aae189" rows="1" colspan="3"  maxlength="165" validate="funcCall[checkFunc]" disabled="true" label="复审意见" /> 
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
