			...
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="akc172" name="dto.akc172" required="true" readonly="true"
						buttonId="hospse" onbuttonclick="chooseHosp(ake017, akc172,0)" label="转外医院"/>
					<powersi:hidden id="ake017" name="dto.ake017" label="转外医院编码" />
				...
				<tr>
					...
					<powersi:textarea id="bke012" rows='3' name="dto.bke012" key="bke012" maxlength="165" colspan="3" label="治疗方案" />
				</tr>
				<tr>
					<powersi:textarea id="bke013" rows='3' name="dto.bke013" key="bke013" maxlength="165" colspan="3" label="医院意见" />
...
<script type="text/javascript">
	...
	//选择医疗机构
	function chooseHosp(objindex, objname,aaa027) {
		if('0'!=aaa027){
			aaa027=$("#aaa027").val();
		}
		parent.popupDialogWithParam({
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bke001",
	                "akc172:1","aka121:1","aae019",
					"bke015","bke017","bke018",
					"bke014","bke020","bke019",
					"bke011:0,1","bke012:0,1",
					"bke013:0,1","aae013:0,1"]; 
	...
	function configSpecialKey(keyid){
		...
		if ("akb021" == keyid) {//选择申请医院
			...
			val++;
		}else if ("aka121" == keyid) {//选择申请疾病
			chooseDis('',$("#aka120")[0], $("#aka121")[0]);
			val++;
		}else if("akc172" == keyid){//转外医院
			chooseHosp($("#ake017")[0], $("#akc172")[0],"0");
			val++;
		}
		return val;
	}
