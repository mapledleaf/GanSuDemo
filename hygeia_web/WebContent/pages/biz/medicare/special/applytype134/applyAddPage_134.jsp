...
<powersi:html>
	<base target="_self">
	<powersi:head title="新增门诊实质性治疗申请" />
<body>
	<powersi:form id="mainForm" action="specialManager!addSpeAppInf.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="bka006" name="dto.bka006" key="bka006" value="114" label="待遇类型"/>
			...
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="aka121" name="dto.aka121" required="true" readonly="true"
						buttonId="di" onbuttonclick="chooseDis('14', aka120,aka121)" label="申请疾病" />
...
<script type="text/javascript">
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bke001",
	                "aka121:1","aae019","bke015","bke014","bke017","bke020","bke018","bke019",
					"bke011:0,1","aae013:0,1"];  
	...
	function configSpecialKey(keyid){
		...
		if ("aka121" == keyid) {//选择申请疾病
			chooseDis('14',$("#aka120")[0], $("#aka121")[0]);
			val++;
		}
		if ("bkb023" == keyid) {//选择专家疾病
			chooseDis('14',$("#bke025")[0], $("#bkb023")[0]);
			val++;
		}
		return val;
	}
