		...
		<powersi:panelbox title="基本信息">
			...
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:textfield id="bke011" required="true" name="dto.bke011" colspan="3" maxlength="200" disabled="true" label="申请原因" />
					<powersi:textfield id="aae127" name="dto.aae127" required="true" disabled="true" key="aae127" mask="date" label="申请日期" />
				</tr>
				<tr>
					<powersi:textfield id="bke033" name="dto.bke033" key="bke033" disabled="true" validate="funcCall[checkFunc]" label="联系电话" />
					<powersi:textfield id="bke001" name="dto.bke001" colspan="3" disabled="true" maxlength="80" label="详细地址" />
					<powersi:textfield id="aae011" name="dto.aae011" key="aae011" disabled="true"  label="经办人"/>
				</tr>
