...
<body>
	<powersi:form id="choosePersonAac001Form" namespace="/medicarespecial"
		action="specialManager!getChoosePersonInfo.action">
		<powersi:panelbox key="查询条件" cssStyle="display:none;">
			<powersi:hidden id="aac002" name="dto.aac002" />
			<powersi:hidden id="aaa027" name="dto.aaa027" />
		</powersi:panelbox>
	</powersi:form>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			row.reset();
			row.loadForm(choosePersonAac001Form);
		});
