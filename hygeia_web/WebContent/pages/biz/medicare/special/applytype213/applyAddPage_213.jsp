...
<body>
	<powersi:form id="mainForm" action="specialManager!addSpeAppInf.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="aka083" name="dto.aka083" key="aka083" value="213" label="申请类型"/>
			...
			<powersi:textfield id="aae016" name="dto.aae016" key="aae016" value="1" label="审核状态"/>
			<powersi:textfield id="aae015" name="dto.aae015" key="aae015" label="审核日期" />
			<powersi:textfield id="aae014" name="dto.aae014" value="<%= userName %>" label="审核人"/>
			<powersi:textfield id="aae189" name="dto.aae189" value="自动审核" label="审核意见" /> 
		...
		<powersi:groupbox title="基本信息">
			<powersi:editorlayout cols="8">
				<tr>
					...
					<powersi:textfield id="aae127" name="dto.aae127" required="true" readonly="true" key="aae127" mask="date" label="申请日期" />
				...
				<tr>
					...
					<powersi:textfield id="aae011" name="dto.aae011" key="aae011" value="<%=userName%>" readonly="true" label="经办人"/>
					<td colspan="4"/>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	function afterGetPerson(param) {
	    ...
	    postJSON("${path}!verifyAfterQuery.action", param, function(json){
	    	if(!checkJSONResult(json,"popup")){
				...
				//申请医院
				$("#akb021").val(json.data.bke053);
				$("#akb020").val(json.data.aaz286);
				changeShield(0);
				//全键盘操作
				firstTabFocus();
		    }
	...
	function saveinfo() {
		...
		$("#aka130").val($("#bka006").val().substr(0,2));//根据待遇类型选择业务类型
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bke011:0,1"]; 
