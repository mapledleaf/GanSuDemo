...
<powersi:html>
<head>
<powersi:head title="离休特殊费用申请详情" target="_self" />
...
<body>
	...
	<powersi:form id="mainForm" action="specialManager!getQueryDetailPage.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="aka083" name="dto.aka083" key="aka083" value="165" label="申请类型"/>
		...
		<powersi:panelbox title="基本信息">
			...
			<powersi:editorlayout cols="8">
				...
				<tr>
					...
					<powersi:textfield id="bke001" name="dto.bke001" colspan="3" disabled="true" label="详细地址" />
		...
		<powersi:groupbox title="详细信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="aka121" name="dto.aka121" required="true" readonly="true" label="申请疾病" />
					<powersi:hidden id="aka120" name="dto.aka120" readonly="true" label="疾病编码" />
					<powersi:textfield id="bke018" name="dto.bke018" key="bke018" disabled="true" label="经治医师签名" />
					<powersi:textfield id="bkb026" name="dto.bkb026" key="bkb026" disabled="true" label="专家签名（科主任）" />
					<powersi:textfield id="bke034" name="dto.bke034" key="bke034" disabled="true" label="医疗机构意见时间" />
				</tr>
							
				<tr>
					<powersi:textarea id="bkb027" rows='1' name="dto.bkb027" key="bkb027" colspan="3" disabled="true" label="专家意见" />
					<powersi:textarea id="bke013" rows='1' name="dto.bke013" key="bke013" colspan="3" disabled="true" label="医疗机构意见" />
				</tr>
				<tr>
					<powersi:textarea id="bke011" rows='1' name="dto.bke011" key="bke011" maxlength="165" colspan="8" disabled="true" label="病情简介及申请依据" />
				</tr>	
			</powersi:editorlayout>
		</powersi:groupbox>
		
		<powersi:groupbox title="审核意见（医保经办机构）">
			<powersi:editorlayout cols="8">
				<tr>
...
<script type="text/javascript">
	...
	//打印
	function doPrint() {
		var param = "dto.comFlag=12&dto.pageFlag=" +$("#pageFlag").val()+"&dto.aaz267=" +$("#aaz267").val()+"&dto.aaa027="+$("#aaa027").val()+"&dto.akb020="+$("#akb020").val();
		/* popupDialog(
				{
