...
<powersi:html>
<head>
<powersi:head title="医院药品目录导入" target="_self" />
</head>
<body>
	...
	<powersi:tabbedpanel id="divTabs">
		...
		<div id="divTab2">
			<powersi:datagrid id="grid" formId="queryForm" delayLoad="true"
				...
				<powersi:datagrid-column name="ake005" key="ake005" label="目录编码*" frozen="true" />
				<powersi:datagrid-column name="ake006" key="ake006" label="目录名称*" frozen="true" />
...
<script type="text/javascript">
	...
	function downloadFile() {
		location.href="${rootPath}/medicare/HospManageAction!downLoadExampleXls.action?bzc001=7";
	}
	...
	function upFile(){
		...
		fileupload.attr('disabled', true);
	 	$("#mainForm").ajaxSubmit({
	        url : "${rootPath}/medicare/HospCataAction!uploadFileCata.action?pageFlag=cata&hospCataDto.caa027=" + $("#caa027").val(),
			datatype : "json",
