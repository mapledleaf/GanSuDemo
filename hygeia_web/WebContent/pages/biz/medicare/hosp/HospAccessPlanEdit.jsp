...
<powersi:html>
<head>
<powersi:head title="修改医院接入计划信息" target="_self" />
</head>
<body>
	<powersi:form id="mainform" disabled="true">
		<powersi:editorlayout cols="6">
			...
			<powersi:editorlayout-row>
				<powersi:textfield id="bae300" name="hospitalAccessPlanDTO.bae300" label="医院接入方式流水号" readonly="true" cols="2"/>
				<powersi:textfield id="bae310" name="hospitalAccessPlanDTO.bae310" label="医院接入计划流水号" readonly="true" cols="2"/>
			</powersi:editorlayout-row>
    ...
    function save(){
         ...
         postJSON("<%=path%>/medicare/HospAccessMgrAction!updateAccessPlan.action",
