...
<body>
	<powersi:form id="mainform" disabled="true">
		<powersi:editorlayout cols="6">
			...
			<powersi:editorlayout-row>
				<powersi:textfield id="bae300" name="hospitalAccessTypeDTO.bae300" label="医院接入方式流水号" readonly="true" cols="2"/>
			</powersi:editorlayout-row>
    ...
    function save(){
         ...
         postJSON("<%=path%>/medicare/HospAccessMgrAction!updateAccessType.action",
