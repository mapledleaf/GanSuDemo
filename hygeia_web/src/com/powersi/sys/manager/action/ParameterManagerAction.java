...
import com.powersi.sys.manager.dao.ParameterDAO;
...
/**
 * The Class ParameterManagerAction.
 */
@Action("ParameterManager")
public class ParameterManagerAction extends UploadAction {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** The Constant CACHE_NAME. */
	private static final String CACHE_NAME = "parameter";
	
	private static ParameterDAO dao = BeanHelper
	...
	public String download() {
		try {
			...
			String fileName = "sys_parameter_"
	...
	public String upload() {
		try {
			...
			if (!UtilFunc.startsWithIgnoreCase(uploadsFileName.get(0),
					"sys_parameter")) {
				saveJSONError("导入文件名必须使用sys_parameter开始");
				return NONE;
			}
