...
import com.powersi.hygeia.framework.codegen.EntityCodeGenerator;
 ...
 * 实体类生成器.
 */
public abstract class EntityCodeGen {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("----------------------------------------------");
			System.out.println("\t生成entity");
			System.out.println("----------------------------------------------");
			
			StringBuilder sb = new StringBuilder();
			String line = null;
			line = ConsoleHelper.readLine("请输入表名(缺省全部表和视图，_表示任意字符，%表示任意字符串，/表示转义符)：");
			...
			EntityCodeGenerator.generateFile(tableFilter, packageName, srcPath,
