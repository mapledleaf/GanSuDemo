...
public class BaseInhospitalManagerAction extends BaseAction {
	...
	public void loadHidDataAndItemName() {
		...
		if (StringUtils.isNotBlank(this.getInHospitalDTO().getAac004())
				&& StringUtils.isBlank(this.getInHospitalDTO().getAac004_name())) {
		...
		if (StringUtils.isNotBlank(this.getInHospitalDTO().getBac001())
				&& StringUtils.isBlank(this.getInHospitalDTO().getBac001_name())) {
		...
		if (StringUtils.isNotBlank(this.getInHospitalDTO().getAaa027())
				&& StringUtils.isBlank(this.getInHospitalDTO().getAaa027_name())) {
			this.getInHospitalDTO().setAaa027_name(CodetableMapping.getDisplayValue("aaa027",
					this.getInHospitalDTO().getAaa027(), this.getInHospitalDTO().getAaa027()));
		}
		if(StringUtils.isBlank(this.getInHospitalDTO().getDistrict())) {
			this.getInHospitalDTO().setDistrict(this.getInHospitalDTO().getAaa027_name());
		}
		if (StringUtils.isNotBlank(this.getInHospitalDTO().getAac008())) {
			this.getInHospitalDTO().setAac008_name(CodetableMapping.getDisplayValue("aac008",
					this.getInHospitalDTO().getAac008(), this.getInHospitalDTO().getAac008()));
		}
		if (StringUtils.isNotBlank(this.getInHospitalDTO().getBka888())) {
			String bka888 = this.getInHospitalDTO().getBka888();
			String bka888Name = "";
			if ("0".equals(bka888)) {
				bka888Name = "正常";
			} else {
				bka888Name = "1".equals(bka888) ? "冻结" : "未参保";
			}
			this.getInHospitalDTO().setBka888_name(bka888Name);
		}
		if ("521".equals(this.getInHospitalDTO().getBka006())&&StringUtils.isNotBlank(this.getInHospitalDTO().getAmc060())) {
			this.getInHospitalDTO().setAmc060(CodetableMapping.getDisplayValue("amc060",
					this.getInHospitalDTO().getAmc060(), this.getInHospitalDTO().getAmc060()));
		}
	}
	...
	public KA14DTO getKa14dto() {
		return ka14dto;
	}

	public void setKa14dto(KA14DTO ka14dto) {
		this.ka14dto = ka14dto;
	}
