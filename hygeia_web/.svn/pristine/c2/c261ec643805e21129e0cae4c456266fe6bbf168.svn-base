...
<body>
	...
	<powersi:groupbox title="数据列表">
		<powersi:datagrid id="grid" formId="queryForm" delayLoad="true" height="410" rowAttrRender="gridRowRender"
			...
			<powersi:datagrid-column display="下限额" name="lower_limit" data="lower_limit" width="10%"  hide="false"/>
			<powersi:datagrid-column display="上限额" name="upper_limit" data="upper_limit" width="10%"  hide="false"/>
