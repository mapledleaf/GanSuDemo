...
<body>
	<powersi:form id="chooseDiseaseForm" namespace="/medicare"
		action="TeamVsSelfPayApplyAction!chooseSelfPayDisease.action">
		<powersi:panelbox key="查询条件">
			...
			<powersi:editorlayout cols="13%,27%,13%,47%">
				<powersi:editorlayout-row>
					<powersi:textfield id="aka120" name="ka16dto.aka120" key="aka120" />
					<powersi:textfield id="aka121" name="ka16dto.aka121" key="aka121" />
				</powersi:editorlayout-row>
				<powersi:editorlayout-row>
					<powersi:textfield id="aka020" name="ka16dto.aka020" key="aka020" />
					<powersi:textfield id="aka021" name="ka16dto.aka021" key="aka021" />
				</powersi:editorlayout-row>
	...
	<powersi:panelbox key="查询结果">
		<powersi:datagrid id="row" formId="chooseDiseaseForm" delayLoad="true"
			...
			enabledSort="false" onSelectRow="chooseDisease" pageSize="10">
