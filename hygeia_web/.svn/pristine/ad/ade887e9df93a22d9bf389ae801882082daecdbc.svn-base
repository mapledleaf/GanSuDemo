...
<body>
	...
	<powersi:form id="mainForm" action="specialManager!getQueryDetailPage.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="aka083" name="dto.aka083" key="aka083" value="126" label="申请类型"/>
		...
		<powersi:groupbox title="详细信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="akc172" name="dto.akc172" required="true" readonly="true" label="转外医院"/>
				...
				<tr>
					...
					<powersi:textfield id="bke020" name="dto.bke020" key="bke020" disabled="true" label="医师意见时间" />
					<powersi:textfield id="bke019" name="dto.bke019" key="bke019" disabled="true" label="主任意见时间" />
				</tr>
				<tr>
					<powersi:textarea id="bke011" rows='1' name="dto.bke011" key="bke011" maxlength="165" colspan="3" disabled="true" label="病情摘要" />
					<powersi:textarea id="bke012" rows='1' name="dto.bke012" key="bke012" maxlength="165" colspan="3" disabled="true" label="治疗方案" />
				</tr>
				<tr>
					<powersi:textarea id="bke013" rows='1' name="dto.bke013" key="bke013" maxlength="165" colspan="3" disabled="true" label="医院意见" />
