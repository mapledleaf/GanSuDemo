...
<body>
	...
	<powersi:groupbox title="数据列表">
		<powersi:datagrid id="grid" formId="queryForm" delayLoad="true" height="410" rowAttrRender="gridRowRender"
			...
			<powersi:datagrid-column display="先支付或床位费" name="defray_type" data="defray_type" width="10%"  hide="false"/>
			<powersi:datagrid-column display="床位限额" name="self_limit" data="self_limit" width="10%"  hide="false"/>
