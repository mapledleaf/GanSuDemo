...
<powersi:editorlayout cols="15%,9%,13%,9%,15%,9%,15%,10%,15%">
	<tr>
		...
		<td id="td1" align="right" class="tdLabel">个人账户余额</td>
		<td id="td2"> 
	...
	<tr>
		...
		<powersi:textfield id="aae030" name="diagnoseInfoDTO.aae030" key="门诊日期" 
	...
	<tr>
		<powersi:textfield id="bkz101" name="diagnoseInfoDTO.bkz101" key="疾病诊断" 
			buttonText="..." buttonId="disinse" onKeyDown="keyDown(this)" value="普通疾病" 
			required="true" readonly="true" onbuttonclick="chooseDis('bka026')" />
	    <powersi:codeselect id="akf001" name="diagnoseInfoDTO.akf001" key="科室" 
			cssClass="select2" list="#request.bka019List"
			headerKey="" headerValue="请选择..." showValue="true"
			onchange="selectbka021()" />
		<powersi:codeselect id="bka021" name="diagnoseInfoDTO.bka021" key="病区" 
			cssClass="select2" list="#request.bka021List"
			headerKey="" headerValue="请选择..." showValue="true" 
			onchange="selectbka503()" />
		<powersi:codeselect id="ake022" name="diagnoseInfoDTO.ake022" key="医保医师" 
			cssClass="select2" list="#request.bka503List" showValue="true" 
			headerKey="" headerValue="请选择..." /> 
	</tr>
	<powersi:hidden id="aab019" name="diagnoseInfoDTO.aab019" />
	<powersi:hidden id="aab001" name="diagnoseInfoDTO.aab001" key="单位电脑号" />
	<powersi:hidden id="aaz267" name="diagnoseInfoDTO.aaz267" key="选点序列号" />
	...
	<powersi:hidden id="bka001" name="diagnoseInfoDTO.bka001" key="费用批次" />
	<powersi:hidden id="bka039" name="diagnoseInfoDTO.bka039" key="完成情况" />
	<powersi:hidden id="akc193" name="diagnoseInfoDTO.akc193" value="00000"/>
	<powersi:hidden id="bka022" name="diagnoseInfoDTO.bka022" key="病区名称" />
	<powersi:hidden id="bka020" name="diagnoseInfoDTO.bka020" key="科室名称" />
	...
	<powersi:hidden id="kc21id" name="diagnoseInfoDTO.kc21id" key="主键" />
