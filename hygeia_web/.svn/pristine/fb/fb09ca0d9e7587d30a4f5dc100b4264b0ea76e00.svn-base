		...
		<powersi:groupbox title="详细信息">
			<powersi:editorlayout cols="8">
				<tr>
					...
					<powersi:textfield id="bke018" name="dto.bke018" key="bke018" label="经治医师签名" />
					<powersi:textfield id="bkb026" name="dto.bkb026" key="bkb026" label="专家签名（主任）" />
					<powersi:textfield id="bke034" name="dto.bke034" key="bke034" mask="date" label="医疗机构意见时间" />
				</tr>
				<tr>
					<powersi:textarea id="bkb027" rows='3' name="dto.bkb027" key="bkb027" maxlength="165" colspan="3" label="专家意见" />
					<powersi:textarea id="bke013" rows='3' name="dto.bke013" key="bke013" maxlength="165" colspan="3" label="医疗机构意见" />
				</tr>
				<tr>
					<powersi:textarea id="bke011" rows='3' name="dto.bke011" key="bke011" maxlength="165" colspan="8" label="病情简介及申请依据" />
				</tr>	
			</powersi:editorlayout>
		</powersi:groupbox>
...
<script type="text/javascript">
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033",
	                "aka121:1","bke018","bkb026","bke034","bkb027:0,1","bke013:0,1","bke011:0,1"]; 
