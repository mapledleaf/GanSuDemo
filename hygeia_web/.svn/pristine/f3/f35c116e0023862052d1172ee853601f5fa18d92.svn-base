...
<body>
	...
	<powersi:groupbox title="数据列表">
		<powersi:datagrid id="grid" formId="queryForm" delayLoad="true" height="410" rowAttrRender="gridRowRender"	
			...
			<powersi:datagrid-column display="计算顺序" name="calc_order" data="calc_order" width="10%"  hide="false"/>
			<powersi:datagrid-column display="基金编码" name="fund_id" data="fund_id" width="10%"  hide="false"/>
			<powersi:datagrid-column display="支付比例" name="scale" data="scale" width="10%"  hide="false"/>
