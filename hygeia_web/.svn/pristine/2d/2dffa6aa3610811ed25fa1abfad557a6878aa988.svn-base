...
function keyDown(para) {
	...
	<tr>
		<powersi:codeselect id="treatment_type" name="diagnoseInfoDTO.treatment_type" key="待遇类型"
			...
			disabled="true" />
		<powersi:textfield id="diagnose_date" name="diagnoseInfoDTO.diagnose_date" key="门特日期"
			onKeyDown="keyDown(this)"  readonly="true" />
		<powersi:textfield id="diagnose" name="diagnoseInfoDTO.diagnose" key="疾病诊断"
			readonly="true" />
		<powersi:textfield id="telephone" name="diagnoseInfoDTO.telephone" key="联系电话"
			readonly="true" />
        <powersi:hidden id="in_disease_name" key="中心疾病名称" name="diagnoseInfoDTO.in_disease_name" />
	</tr>
	<tr>
	...
	<powersi:hidden id="biz_type" name="diagnoseInfoDTO.biz_type" value="13" />
