...
<body>
	<powersi:form id="mainForm" action="specialManager!addSpeAppInf.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="aka083" name="dto.aka083" key="aka083" value="191" label="申请类型"/>
			...
			<powersi:textfield id="bka006" name="dto.bka006" key="bka006" value="121" label="待遇类型"/>
