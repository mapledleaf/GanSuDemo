...
import com.powersi.ssm.biz.medicare.universal.action.BaseInhospitalManagerAction;
...
@Action(value = "InhospitalManagerAction_HIS", results = {
		@Result(name = "applyBack", location = "/pages/biz/medicare/diagnose_his/applyBack.jsp"),
		@Result(name = "registerKsyd", location = "/pages/biz/medicare/diagnose_his/RegisterKsyd.jsp"),
		@Result(name = "registerSnyd", location = "/pages/biz/medicare/diagnose_his/RegisterSnyd.jsp"),
		@Result(name = "registerMaternity", location = "/pages/biz/medicare/diagnose_his/RegisterMaternity.jsp"),
		@Result(name = "registerInjury", location = "/pages/biz/medicare/diagnose_his/RegisterInjury.jsp"),
		@Result(name = "registerSpecial", location = "/pages/biz/medicare/diagnose_his/RegisterSpecial.jsp"),
		@Result(name = "register", location = "/pages/biz/medicare/diagnose_his/Register.jsp"),
		@Result(name = "registerHomeSickbed", location = "/pages/biz/medicare/diagnose_his/RegisterHomeSickbed.jsp"),
		@Result(name = "modifyRegisterKsyd", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterKsyd.jsp"),
		@Result(name = "modifyRegisterSnyd", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterSnyd.jsp"),
		@Result(name = "modifyRegisterMaternity", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterMaternity.jsp"),
		@Result(name = "modifyRegisterInjury", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterInjury.jsp"),
		@Result(name = "modifyRegisterSpecial", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterSpecial.jsp"),
		@Result(name = "modifyRegister", location = "/pages/biz/medicare/diagnose_his/ModifyRegister.jsp"),
		@Result(name = "modifyRegisterHomeSickbed", location = "/pages/biz/medicare/diagnose_his/ModifyRegisterHomeSickbed.jsp"),
		@Result(name = "inputFeeSnyd", location = "/pages/biz/medicare/diagnose_his/InputFeeSnyd.jsp"),
		@Result(name = "inputFeeKsyd", location = "/pages/biz/medicare/diagnose_his/InputFeeKsyd.jsp"),
		@Result(name = "inputFeeMaternity", location = "/pages/biz/medicare/diagnose_his/InputFeeMaternity.jsp"),
		@Result(name = "inputFeeInjury", location = "/pages/biz/medicare/diagnose_his/InputFeeInjury.jsp"),
		@Result(name = "inputFeeSpecial", location = "/pages/biz/medicare/diagnose_his/InputFeeSpecial.jsp"),
		@Result(name = "inputFeeHomeSickbed", location = "/pages/biz/medicare/diagnose_his/InputFeeHomeSickbed.jsp"),
		@Result(name = "inputFeeComminter", location = "/pages/biz/medicare/comminter/InputFeeComminter.jsp"),
		@Result(name = "outRegisterKsyd", location = "/pages/biz/medicare/diagnose_his/OutRegisterKsyd.jsp"),
		@Result(name = "outRegisterSnyd", location = "/pages/biz/medicare/diagnose_his/OutRegisterSnyd.jsp"),
		@Result(name = "outRegisterMaternity", location = "/pages/biz/medicare/diagnose_his/OutRegisterMaternity.jsp"),
		@Result(name = "outRegisterInjury", location = "/pages/biz/medicare/diagnose_his/OutRegisterInjury.jsp"),
		@Result(name = "outRegisterSpecial", location = "/pages/biz/medicare/diagnose_his/OutRegisterSpecial.jsp"),
		@Result(name = "outRegister", location = "/pages/biz/medicare/diagnose_his/OutRegister.jsp"),
		@Result(name = "outRegisterHomeSickbed", location = "/pages/biz/medicare/diagnose_his/OutRegisterHomeSickbed.jsp"),
		@Result(name = "outChargeKsydCorrect", location = "/pages/biz/medicare/diagnose_his/OutChargeKsydCorrect.jsp"),
		@Result(name = "outChargeKsyd", location = "/pages/biz/medicare/universal/OutChargeKsyd.jsp"),
		@Result(name = "outChargeSnyd", location = "/pages/biz/medicare/universal/OutChargeSnyd.jsp"),
		@Result(name = "outChargeMaternity", location = "/pages/biz/medicare/diagnose_his/OutChargeMaternity.jsp"),
		@Result(name = "outChargeInjury", location = "/pages/biz/medicare/diagnose_his/OutChargeInjury.jsp"),
		@Result(name = "outChargeSpecial", location = "/pages/biz/medicare/diagnose_his/OutChargeSpecial.jsp"),
		@Result(name = "outCharge", location = "/pages/biz/medicare/diagnose_his/OutCharge.jsp"),
		@Result(name = "outChargeHomeSickbed", location = "/pages/biz/medicare/diagnose_his/OutChargeHomeSickbed.jsp"),
		@Result(name = "outChargeComminter", location = "/pages/biz/medicare/comminter/OutChargeComminter.jsp"),
		@Result(name = "queryuniversalKsyd", location = "/pages/biz/medicare/diagnose_his/QueryuniversalKsyd.jsp"),
		@Result(name = "queryuniversalSnyd", location = "/pages/biz/medicare/diagnose_his/QueryuniversalSnyd.jsp"),
		@Result(name = "queryuniversalMaternity", location = "/pages/biz/medicare/diagnose_his/QueryuniversalMaternity.jsp"),
		@Result(name = "queryuniversalInjury", location = "/pages/biz/medicare/diagnose_his/QueryuniversalInjury.jsp"),
		@Result(name = "queryuniversalSpecial", location = "/pages/biz/medicare/diagnose_his/QueryuniversalSpecial.jsp"),
		@Result(name = "queryInHospComminter", location = "/pages/biz/medicare/comminter/QueryuniversalComminter.jsp"),
		@Result(name = "queryuniversalHomeSickbed", location = "/pages/biz/medicare/diagnose_his/QueryuniversalHomeSickbed.jsp"),
		@Result(name = "queryuniversal", location = "/pages/biz/medicare/diagnose_his/Queryuniversal.jsp"),
		@Result(name = "queryForegiftDetail", location = "/pages/biz/medicare/diagnose_his/QueryForegiftDetail.jsp"), 
		@Result(name = "printForegift", location = "/pages/biz/medicare/diagnose_his/QueryForegiftPrint.jsp"), 
		@Result(name = "printForegiftDetail", location = "/pages/biz/medicare/diagnose_his/QueryForegiftPrintDetail.jsp"),
		@Result(name = "queryInHospital", location = "/pages/biz/medicare/diagnose_his/QueryInHospital.jsp"),
		@Result(name = "queryForegift", location = "/pages/biz/medicare/diagnose_his/QueryForegift.jsp")})
			...
			if (this.isPostRequest()) {
				try {
					...
					MCCEbizh120102Service mCCEbizh120102Service = getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120102Service.class, this.getInHospitalDTO().getAkb020());
		...
		try {
			if (this.isPostRequest()) {
				try {
					...
					// 通过就医登记号查询记录，获取插入的kcd1id
					Map param = new HashMap();
					param.put("akb020", BizHelper.getAkb020());
					param.put("aaz217", inHospitalDTOTemp.getAaz217());
					param.put("bka039", "0");
					List<KCD1> kcd1List = diagnoseQueryService_HIS.queryYunInHospPersonInfo(param);
					KCD1 kcd1his = new KCD1();
					if (kcd1List.size() > 0) {
						kcd1his = kcd1List.get(0);
					} else {
						return ERROR;
					}
					// 修改临时表中的kcd1id
					...
					kmap.put("akc190", akc190);
					kmap.put("akb020", BizHelper.getAkb020());
					kmap.put("kcd1id", kcd1his.getKcd1id());
					kmap.put("aaz217", kcd1his.getAaz217());
					kmap.put("bka044", "1");
					diagnoseQueryService_HIS.updataKcd1Hosp(kmap);
					// 查询费用信息
					List<KCD2_HospFee_HisDTO> hospfeeList = diagnoseQueryService_HIS.queryHospFeeInfo(param);
					if (hospfeeList.size() > 0) {
						KCD2_HospFee_HisDTO his = hospfeeList.get(0);
						param.put("akc190", akc190);
						param.put("kcd1id", kcd1his.getKcd1id());
						diagnoseQueryService_HIS.updateKcd2hospFeeAaz217(param);
					}
					this.getBeanService().copyProperties(inHospitalDTOTemp, this.getInHospitalDTO(), true);
			...
			if (StringUtils.isNotBlank(this.getInHospitalDTO().getAkf001())) {
				...
				if (doctorRows != null) {
					for (HospInfoDTO doctorRow : doctorRows) {
						ake022List.put(doctorRow.getBkc274(), doctorRow.getBkc275());
					}
				}
			}
			this.setJSONReturn(ake022List);
		} catch (Throwable e) {
			String errLogSn = this.addErrSNInfo();
			this.getCommunalService().error(this.logger, e, new StringBuilder(errLogSn).append("入参:")
					.append(this.addNotBlankParameters()).append(":处理结果:").toString());
	...
	public String loadBka021List() {
		try {
			...
			if (StringUtils.isNotBlank(this.getInHospitalDTO().getAkf001())) {
				...
				HospApiService hospApiService = this.getHygeiaServiceManager().getBeanByClass(MCCEHospApiServiceImpl.class,
						this.getInHospitalDTO().getAkb020());
				List<HospInfoDTO> areaRows = hospApiService.queryHospArea(this.getInHospitalDTO().getAkb020(),
						hospInfoDto);
				
				if (areaRows != null) {
					for (HospInfoDTO areaRow : areaRows) {
						bka021List.put(StringUtils.trim(areaRow.getBkc153()), areaRow.getBkc154());
					}
				}
			}
			...
			if (this.isPostRequest()) {
				try {
					...
					MCCEbizh120104Service mCCEbizh120104Service = this.getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120104Service.class, this.getInHospitalDTO().getAkb020());
...
//					MCCEbizh120133Service mCCEbizh120133Service = this.getHygeiaServiceManager()
//							.getBeanByClass(MCCEbizh120133Service.class, this.getInHospitalDTO().getAkb020());
//					for (InHospitalDTO inHospitalDTORow : inHospitalDTORows) {
//						if (StringUtils.isNotBlank(inHospitalDTORow.getBka006())) {
//							inHospitalDTORow.setBka006_name(
...
//											inHospitalDTORow.getBka006(), inHospitalDTORow.getBka006()));
//						}
//						if (StringUtils.isNotBlank(inHospitalDTORow.getAaz217())
//								&& "4418".equals(inHospitalDTORow.getAaa027().substring(0, 4))) {
//							inHospitalDTORow.setAae101("2");
//							InHospitalDTO hostpital = mCCEbizh120133Service.fallbackApplyQueryDTO(inHospitalDTORow);
//							if (hostpital == null) {
//								inHospitalDTORow.setAaa104("未申请");
//							} else {
//								String numb = hostpital.getAae016();
//								if ("6".equals(numb)) {
//									inHospitalDTORow.setAaa104("审核通过");
//								} else if ("3".equals(numb) || "5".equals(numb) || "7".equals(numb)) {
//									inHospitalDTORow.setAaa104("审核不通过");
//								} else {
//									inHospitalDTORow.setAaa104("未审核");
//								}
//							}
//							inHospitalDTORow.setAae101("1");
//							InHospitalDTO inhost = mCCEbizh120133Service.fallbackApplyQueryDTO(inHospitalDTORow);
//							if (inhost == null) {
//								inHospitalDTORow.setAae016("未申请");
//							} else {
//								String num = inhost.getAae016();
//								if ("6".equals(num)) {
//									inHospitalDTORow.setAae016("审核通过");
//								} else if ("3".equals(num) || "5".equals(num) || "7".equals(num)) {
//									inHospitalDTORow.setAae016("审核不通过");
//								} else {
//									inHospitalDTORow.setAae016("未审核");
//								}
//							}
//						}
//					}
		...
		try {
			if (this.isPostRequest()) {
				try {
					...
					if("1".equals(this.getParameter("hospInfoflag"))){
						...
						param.put("akb020",BizHelper.getAkb020());
						param.put("bka044", "0");
						param.put("akc190", this.getInHospitalDTO().getAkc190());
						diagnoseQueryService_HIS.updataKcd1Hosp(param);
					}
					this.getBeanService().copyProperties(inHospitalDTOTemp, this.getInHospitalDTO(), true);
		...
		try {
			if (this.isPostRequest()) {
				try {
					...
					/**
					 * 通用接口台账费用处理
					 * 在办理门诊退费或取消出院结算时，根据akb020和aaz217查询台账信息，获取是否存在发票信息；
					 */
		...
		try {
			if (this.isPostRequest()) {
				try {
					...
					MCCEbizh120002Service mCCEbizh120002Service = this.getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120002Service.class, getInHospitalDTO().getAkb020());
					InHospitalDTO inHospitalDTOTemp = mCCEbizh120002Service.checkAndSaveFeeInfo(this.getInHospitalDTO(),
							inHospitalDTORows);
					this.getBeanService().copyProperties(inHospitalDTOTemp, this.getInHospitalDTO(), true);
	...
	public String feeSelectKsyd() {
		try {
			...
			MCCEbizh120203Service mCCEbizh120203Service = this.getHygeiaServiceManager()
					.getBeanByClass(MCCEbizh120203Service.class, this.getInHospitalDTO().getAkb020());
	 ...
	 * @return
	 */
	public String tryCalcTreatSnyd() {
		try {
			this.initCtrlInHospitalDTO(aka130_72);
			this.getInHospitalDTO().setBka438(bka438_1);
			this.getInHospitalDTO().setBka046(BizHelper.getLoginUser());
	 ...
	 * @return
	 */
	public String outChargeSnydTryCalcTreat() {
		try {
			initCtrlInHospitalDTO(aka130_72);
			this.getInHospitalDTO().setBka438(bka438_2);
			this.getInHospitalDTO().setBka046(BizHelper.getLoginUser());
			this.getInHospitalDTO().setBka047(BizHelper.getUserName());
			MCCEbizh120003Service mCCEbizh120003Service = this.getHygeiaServiceManager()
			...
			if (this.isPostRequest()) {
				try {
					...
					MCCEbizh120106Service mCCEbizh120106Service = this.getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120106Service.class, this.getInHospitalDTO().getAkb020());
		...
		try {
			if (this.isPostRequest()) {
				try {
					...
					this.getInHospitalDTO().setBka047(BizHelper.getUserName());
					MCCEbizh120106Service mCCEbizh120106Service = this.getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120106Service.class, getInHospitalDTO().getAkb020());
					InHospitalDTO inHospitalDTOTemp = mCCEbizh120106Service.outCharge(this.getInHospitalDTO());
					this.getBeanService().copyProperties(inHospitalDTOTemp, this.getInHospitalDTO(), true);
	...
	public String queryFundPay() {
		try {
			...
			MCCEbizh120312Service mCCEbizh120312Service = this.getHygeiaServiceManager()
					.getBeanByClass(MCCEbizh120312Service.class, this.getInHospitalDTO().getAkb020());
		...
		try {
			  ...
			  if (this.isPostRequest()) {
				  ...
				  if("getBkn2DtoList".equals(getParameter("type","")))//预付款列表
					{
						HospApiService hospService = this.getHygeiaServiceManager().getBeanByClass(HospApiService.class, this.getInHospitalDTO().getAkb020());
				...
				inHospitalDTOParam.setAkb020(this.getInHospitalDTO().getAkb020());
				 MCCEbizh120102Service mCCEbizh120102Service = this.getHygeiaServiceManager()
							.getBeanByClass(MCCEbizh120102Service.class, this.getInHospitalDTO().getAkb020());
				 InHospitalDTO inHospitalDTOTemp = mCCEbizh120102Service
							.queryAaz217(inHospitalDTOParam);
					...
					bkn2Dto.setBkn149(DateFunc.parseDate(DateFunc.dateToString(new Date(), "yyyyMMdd")));
					bkn2Dto.setBkn565(BizHelper.getLoginUser());
					bkn2Dto.setBkn568(new BigDecimal(bkn568));
					bkn2Dto.setBkn574("2");
					HospApiService hospService = this.getHygeiaServiceManager().getBeanByClass(HospApiService.class, this.getInHospitalDTO().getAkb020());
					inHospitalDTOTemp.setBka245(bkn2Dto.getBkn568().add(new BigDecimal(inHospitalDTOTemp.getBka245())).toString());
			  ...
			  else  if("printForegift".equals(getParameter("type","")))
		      {
					...
					if(this.getInHospitalDTO().getAaz217()==null || StringUtils.isBlank(this.getInHospitalDTO().getAaz217()))
					{
						throw new HygeiaException("aaz217为空");
					}
					 this.initCtrlInHospitalDTO();// this.initCtrlInHospitalDTO(aka130_12);//CommBizServiceImpl();
					 MCCEbizh120102Service mCCEbizh120102Service = this.getHygeiaServiceManager()
								.getBeanByClass(MCCEbizh120102Service.class, this.getInHospitalDTO().getAkb020());
					 InHospitalDTO inHospitalDTOTemp = mCCEbizh120102Service
								.queryAaz217(this.getInHospitalDTO());
						if (inHospitalDTOTemp==null) {
							throw new HygeiaException("未找到对应数据["+this.getInHospitalDTO().getAaz217()+"]!");
						}
					...
					/*HospApiService hospService = this.getHygeiaServiceManager().getBeanByClass(HospApiService.class, this.getInHospitalDTO().getAkb020());
					List<Bkn2Dto> bkn2DtoList =hospService.selectByBkn2Aaz218(this.getInHospitalDTO());
					    
					 setAttribute("bkn2DtoList", bkn2DtoList.get(0));*/
				      this.getInHospitalDTO().setAac004_name(
								CodetableMapping.getDisplayValue("aac004",
				     ...
				     // getInHospitalDTO().getAae140()
				      
				     String reportIDfirst = inhospitalManagerService.createForegiftReport("inhosp/foregift.xls", getInHospitalDTO().getAaz217()+"_foregift",
								1, mapData, "foregift", this.getInHospitalDTO().getAae011());
				     mapData=null; 
			  ...
			  else  if("printForegiftDetail".equals(getParameter("type","")))
		      {
				  ...
				  if("".equals(bkn2IdString))
					 ...
					 HospApiService hospService = this.getHygeiaServiceManager().getBeanByClass(HospApiService.class, this.getInHospitalDTO().getAkb020());
					 Bkn2Dto bkn2Dto =hospService.selectByPrimaryKey(this.getInHospitalDTO().getAkb020(), Integer.parseInt(bkn2IdString));
					 if(bkn2Dto==null)
					 {
					...
					List<Bkn2Dto> bkn2DtoList =hospService.selectByBkn2Aaz218(this.getInHospitalDTO());
					 ...
					 setAttribute("bkn2DtoList", bkn2DtoList.get(0));*/
				      ...
				      Map reportForegiftMap=new HashMap();
				     this.getBeanService().copyProperties(this.getInHospitalDTO(), reportForegiftMap, true);
				     reportForegiftMap.put("jfrq", this.getDateService().dateToString(bkn2Dto.getBkn149(), "yyyy-MM-dd HH:mm:ss"));
				     ...
				     String reportIDfirst = inhospitalManagerService.createForegiftReport("inhosp/foregiftDetail.xls", getInHospitalDTO().getAaz217()+"_foregiftDetail",
								1, mapData, "foregiftDetail", this.getInHospitalDTO().getAae011());
				     mapData=null; 
		    	  setAttribute("reportIDfirst", reportIDfirst); 
					...
					List<Bkn2Dto> bkn2DtoList =hospService.selectByBkn2Aaz218(this.getInHospitalDTO());
					 ...
					 setAttribute("bkn2DtoList", bkn2DtoList.get(0));*/
				      this.getInHospitalDTO().setAac004_name(
								CodetableMapping.getDisplayValue("aac004",
										this.getInHospitalDTO().getAac004(), this.getInHospitalDTO().getAac004()));
				      this.getInHospitalDTO().setBka035_name(
								CodetableMapping.getDisplayValue("bka035",
	...
	public String loadDiagnoseInfos() {
		try {
			...
			MCCEbizh120102Service mCCEbizh120102Service = this.getHygeiaServiceManager()
					.getBeanByClass(MCCEbizh120102Service.class, BizHelper.getAkb020());
