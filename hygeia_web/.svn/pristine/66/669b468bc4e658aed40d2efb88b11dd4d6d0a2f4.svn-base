...
<body>
	<powersi:form id="choosePersonAac001Form" namespace="/common"
		action="CommonManagerAction!choosePersonAac001.action">
		<powersi:panelbox key="查询条件" cssStyle="display:none;">
			<powersi:hidden id="argName" name="inHospitalDTO.argName" />
