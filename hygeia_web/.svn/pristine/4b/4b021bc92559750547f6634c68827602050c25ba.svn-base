...
<powersi:form id="accessPlanForm" name="accessPlanForm" namespace="/medicare"
	...
	<powersi:panelbox key="panel_query" title="接入方式信息">
		...
		<powersi:editorlayout>
	        <powersi:editorlayout-row>
		        <powersi:textfield id="bae300" name="hospitalAccessPlanDTO.bae300"  key="bae300" label="医院接入方式流水号" readonly="true"/>
		        <powersi:textfield id="akb020" name="akb020"  key="akb020" label="医院编号" readonly="true"/>
	        </powersi:editorlayout-row>
	        <powersi:editorlayout-row>
		        <powersi:textfield id="akb021" name="akb021"  key="akb021" label="医院编号" readonly="true"/>
		        <powersi:textfield id="bae302" name="hospitalAccessTypeDTO.bae302" label="经办人" required="true" readonly="true" />
				<powersi:textfield id="bae303" name="hospitalAccessTypeDTO.bae303" label="经办时间" mask="date"  readonly="true" />
	        </powersi:editorlayout-row>
		</powersi:editorlayout>
	</powersi:panelbox>
</powersi:form>		
	<powersi:groupbox title="接入计划信息列表">
		<a>双击单条信息修改明细。</a>
