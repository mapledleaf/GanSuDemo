...
%>equest.setAttribute("path", request.getContextPath() + "/medicarespecial/specialManager");
%>

<powersi:html>
	<base target="_self">
	<powersi:head title="28天再住院申请详情" />
<body>
	...
	<powersi:form id="mainForm" action="specialManager!getQueryDetailPage.action" namespace="/medicarespecial">
		...
		<div style="display: none">
			...
			<powersi:textfield id="bka006" name="dto.bka006" key="bka006" value="125" label="待遇类型"/>
		...
		<powersi:panelbox title="基本信息">
			...
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:textfield id="aac001" name="dto.aac001" key="aac001" disabled="true" label="个人电脑号" />
					<powersi:textfield id="aac003" name="dto.aac003" key="aac003" disabled="true" label="姓名" />
					<powersi:textfield id="aac004" name="dto.aac004" key="aac004" disabled="true" label="性别" />
		...
		<powersi:groupbox title="审核意见">
			<powersi:editorlayout cols="8">
				<tr>
					...
					<powersi:textfield id="aae015" name="dto.aae015" required="true" key="aae015" mask="date" disabled="true" label="审核日期" />
					<powersi:textfield id="aae189" name="dto.aae189"  colspan="1"  maxlength="165" validate="funcCall[checkFunc]" disabled="true" label="审核意见" />
					<td colspan="2"/>
				</tr>
			</powersi:editorlayout>
		</powersi:groupbox>
