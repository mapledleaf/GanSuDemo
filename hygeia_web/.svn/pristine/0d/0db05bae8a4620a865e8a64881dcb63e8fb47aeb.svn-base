...
<body>
			...
			<powersi:editorlayout cols="10">
				<powersi:editorlayout-row>
					...
					<powersi:codeselect id="ake003" name="hospCataDto.ake003" label="目录类别" 
						headerKey="2,3" headerValue="请选择.." codeType="ake003"
						codeFilter="data_value in ('2','3') "/>
	...
	<powersi:panelbox key="panel_result" title="中心项目目录列表">
		<powersi:datagrid id="grid" formId="queryForm" delayLoad="true" enabledSort="false"
			...
			showExportExcel2007="true" showExportPdf="true" exportFileName="'医保项目目录信息'">
			<powersi:datagrid-column name="bkc144" display="项目编码" />
			<powersi:datagrid-column name="bkc143" display="项目名称" />
			...
			<powersi:datagrid-column name="ala011" display="工伤目录" code="yes_no" />
			...
			<powersi:datagrid-column name="bkc118" display="职工门诊目录" code="yes_no" />
