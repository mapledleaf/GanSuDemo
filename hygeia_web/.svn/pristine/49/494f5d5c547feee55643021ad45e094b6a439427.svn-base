...
<powersi:html>
	<base target="_self">
	<powersi:head title="新增身份证特殊情况申请" />
<body>
	<powersi:form id="mainForm" action="specialManager!addSpeAppInf.action" namespace="/medicarespecial">
		...
		<powersi:groupbox title="详细信息">
			<powersi:editorlayout cols="8">
				<tr>
					<powersi:codeselect id="bka006" name ="dto.bka006" list="%{#{'131':'门诊特殊病','180':'大病特药'}}" required="true" label="待遇类型" />
					<powersi:codeselect id="bke035" name="dto.bke035" codeType="bke035"  required="true" label="申报原因"/>
					<td colspan="6"/>
				</tr>
...
<script type="text/javascript">
	...
	*/
	var tabKeyConf=["akb021:1","aae030:1","aae031:1","bke033","bka006:1","bke035:1"]; 
