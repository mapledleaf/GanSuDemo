 ...
 * 
 * <pre>
 * 1、MedicareCommDTO里所有字段千万都不要写死默认值，默认值在service层处理；
 ...
 *
 */
public class MedicareCommDTO extends Page {
	...
	private String bka017_last;//
	private String bka032_last;//
	 ...
	 * 
	 * @param pcardinfo
	 *            依次为：卡识别码、卡号。各数据项之间以“|”分割，且最后一个数据项以“|”结尾
	 */
	 ...
	 * 
	 * @param ppayinfo
	 *            依次为：本次消费总金额(小于42949672.95的小数，小数点后保留两位)、个人账户交易金额和统筹基金支付金额相加的总金额（小于42949672.95的小数，小数点后保留两位）、交易时间（格式为YYYYMMDDHHMMSS）。各数据项之间以“|”分割，且最后一个数据项以“|”结尾。
	 */
	 ...
	 * 
	 * @param bka980
	 *            reportTemplateID报表模板ID，一般存放在工程的report目录下，按业务分多级子目录，用点拼接，例如：
	 *            medicare/hosp/xxx.xls
	 */
	 ...
	 * 
	 * @param bka981
	 *            bizID业务唯一编号，默认请传输空，这个用于后续按照业务的唯一编号来查询报表，全局不允许重复
	 */
	 ...
	 * 
	 * @param bka982
	 *            keepDays保留天数，0标识永久保留，超过配置的天数，生成的报表数据将被删除
	 */
	 ...
	 * 
	 * @param bka983
	 *            report_comm报表生成说明，业务传递，例如：财务2015年度数据
	 */
	...
	/**
	 * 
	 * @return 取此待遇类型的二级目录使用标志“0”排除法“1”准入法“2”单病种“9”没有二级目录(
	 ...
	 * 
	 * @param bka781
	 *            取此待遇类型的二级目录使用标志“0”排除法“1”准入法“2”单病种“9”没有二级目录(
	 *            special_range_use_flag)
	 */
	 ...
	 *            业务开始日期
	 */
	public void setBka017_last(String bka017_last) {
		this.bka017_last = bka017_last;
	}
	 ...
	 *            业务结束日期
	 */
	public void setBka032_last(String bka032_last) {
		this.bka032_last = bka032_last;
	}
	...
	/**
	 * 
	 * @return 登记标志(0：正常 1：转院 2：二次返院（审批通过后rela_serial_no为空） 3：急诊留观转住院
	 *         4：90天或180天结算)
	 */
	 ...
	 * 
	 * @param bka016
	 *            登记标志(0：正常 1：转院 2：二次返院（审批通过后rela_serial_no为空） 3：急诊留观转住院
	 *            4：90天或180天结算)
	 */
