 ...
 *
 */
public class CatalogDTO extends Page{
	...
	private String bkc194; //异名医院匹配UUID 
	private String aaz107;//定点医疗机构id 
	private String ake003;//三大目录类别 
	private String bkc109;//异名id 
	private String bkc144;//异名库目录编码 
	private String bkc143;//异名库目录名称 
	private String ake006;//医疗机构三大目录名称 
	private String aka020;//拼音助记码
	private String aka021;//五笔助记码
	private BigDecimal aka053;//单处方先自付比例
	private BigDecimal aka057;//先自付比例
	private String aka063;//医疗发票项目类别
	private String aja006;//失业使用标志
	private String aka022;//医疗使用标志
	private String ala011;//工伤使用标志
	private String ama011;//生育使用标志
	private String bkc100;//目录分类编码
	private BigDecimal bkc106;//支付比例
	private String bkc104;//特殊人群标记    
	private String bkc115;//城居门诊专科标志
	private String bkc118;//城职门诊专科标志
	private String bkc189;//儿童补充目录（居民医保）
	private String bkc190;//基本药物标示
	private String bkc191;//基本药物标示
	private String aae100;//当前有效标
	private String aae030;//开始时间
	private String aae031;//结束时间
	private String bkc138;//医院目录剂型,录入中文名称
	private String bkc139;//医院目录规格
	private BigDecimal bkc140;//医院目录单价
	private String bkc142;//收费标准来源
	private String bkc148;//医院药品剂量单位
	private String bkc001;//版本号
	private String aae036;//经办时间
	private String aae011;//经办人工号
	private String bae100;//经办人
	private String aae015;//审核时间
	private String aae014;//审核人工号
	private String bae101;//审核人
	private String aae016;//复核标志
	private String bkc248;//初审意见
	private String bkc249;//复审意见
	private String aae013;//备注
	private String bkc250;//医疗机构匹配时间
	private String bkc253;//锁定标记''0' ''已申请' ''1' ''已复审' ''2' ''复审不通过' ''3已初审’,''4初审未通过''
	private String bkc254;//锁定申请人
	private String bkc255;//锁定申请时间
	private String bkc256;//锁定申请人工号
	private String bkc257;//锁定复审人
	private String bkc258;//锁定复审时间
	private String bkc259;//锁定复审人工号
	private String bkc260;//锁定原因
	private String bkc263;//锁定初审人
	private String bkc264;//锁定初审人工号
	private String bkc265;//锁定初审人时间
	private String bkc266;//修改的匹配到期时间
	private String aae406;//医疗机构匹配人
	private String aae407;//医疗机构匹配人工号
	private int bpe001;//内控稽核状态0：“无”，2：“取消禁止支付”，3：“有风险”，10：“禁止支付”，13：“终止业务”
	private String bkm023;//批准日期（医院信息）
	private String bkm024;//批准文号/注册号（医院信息）
	private String bkm029;//医保识别码
	private String caa027;//中心标识编码
	private String bke215;
	private String bke216;
	private String bke217;//离休人员先支付比例
	private String ake105;//中心药监本位码(ka40中字段)
	...
	public BigDecimal getAka053() {
		return aka053;
	}
	public void setAka053(BigDecimal aka053) {
		this.aka053 = aka053;
	}
	public BigDecimal getAka057() {
		return aka057;
	}
	public void setAka057(BigDecimal aka057) {
		this.aka057 = aka057;
	}
	...
	public BigDecimal getBkc106() {
		return bkc106;
	}
	public void setBkc106(BigDecimal bkc106) {
		this.bkc106 = bkc106;
	}
	...
	public String getBkc250() {
		return bkc250;
	}
	public void setBkc250(String bkc250) {
		this.bkc250 = bkc250;
	}
	...
	public String getBkc255() {
		return bkc255;
	}
	public void setBkc255(String bkc255) {
		this.bkc255 = bkc255;
	}
	...
	public String getBkc258() {
		return bkc258;
	}
	public void setBkc258(String bkc258) {
		this.bkc258 = bkc258;
	}
	...
	public String getBkc265() {
		return bkc265;
	}
	public void setBkc265(String bkc265) {
		this.bkc265 = bkc265;
	}
	public String getBkc266() {
		return bkc266;
	}
	public void setBkc266(String bkc266) {
		this.bkc266 = bkc266;
	}
	...
	public int getBpe001() {
		return bpe001;
	}
	public void setBpe001(int bpe001) {
		this.bpe001 = bpe001;
	}
	public String getBkm023() {
		return bkm023;
	}
	public void setBkm023(String bkm023) {
		this.bkm023 = bkm023;
	}
